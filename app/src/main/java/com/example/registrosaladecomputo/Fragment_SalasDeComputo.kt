 ...
 * Use the [Fragment_SalasDeComputo.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment_SalasDeComputo : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragment_SalasDeComputo.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fragment_SalasDeComputo().apply {
